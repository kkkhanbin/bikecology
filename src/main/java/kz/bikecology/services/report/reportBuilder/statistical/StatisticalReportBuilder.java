package kz.bikecology.services.report.reportBuilder.statistical;
...
public class StatisticalReportBuilder extends ReportBuilder {
    private final String TEMPLATES_DIR = "src/main/resources/reportTemplates/statistical";
    private final Map<Integer, String> TEMPLATE_PATHS = new HashMap<>();

    public StatisticalReportBuilder() {
        super();
    ...
    protected HashMap<String, String> getSourceData(int facilityId, int quarter, int year) {
        List<Source> sources = sourceDAO.getByFacilityId(facilityId);
        ...
        sourceData.put("numberOfOrganizedSources", String.valueOf(Source.getNumberOfOrganized(sources)));
